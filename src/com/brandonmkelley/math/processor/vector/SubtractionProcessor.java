...
public class SubtractionProcessor extends Processor {
  ...
  public void process() {
    ...
    System.out.print("v1 - v2 is: ");
    System.out.println(out.sub(_v1, _v2));
    System.out.print("v2 - v1 is: ");
    System.out.println(out.sub(_v2, _v1));
    System.out.println();
